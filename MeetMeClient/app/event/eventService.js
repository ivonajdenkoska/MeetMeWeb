(function (angular) {
    ...
    function EventServiceFn($resource, localStorageService, ngAuthSettings) {
        var resource = $resource('https://localhost:44362/api/event', {},
        {
            ...
            deleteEvent: { method: "POST", url: 'https://localhost:44362/api/event/delete', params: { title: '@title', id: '@id', start: '@start', end: '@end' }, headers: { 'Content-Type': 'application/json; charset=utf8' } },
        ...
        function deleteEvent(title,id,start,end) {
            return resource.deleteEvent({ title: title, id: id, start: start, end: end}, function (response) {
                return response;
            }).$promise;
        };
